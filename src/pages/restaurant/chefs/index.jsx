...
function Chefs() {
    return (
        <div className="relative mt-[60px]">
            ...
            <div className="text-[#FFF] font-[700] font-['Helvetica'] text-[48px]">
                <span className="text-primary-orange">Me</span><span>et Our Chef</span>
            </div>
            <div className="relative z-[1] flex flex-row w-[100%] gap-[20px]">
                <div className="chefcard relative w-[25%]  cursor-pointer">
