    ...
    return (
        <div className="flex flex-row relative w-[auto] pt-[120px] bg-primary-background">
            <div className="text-left w-[50%]">
                ...
                <div className="font-['Helvetica'] text-[48px] leading-[56px] font-[700] text-[#FFF] mb-[32px]">
                    <span className="text-primary-orange">We</span>
                    <span> Create the best<br /></span>
                    <span>Foody product</span>
                </div>
                <div className="w-[526px] font-['Inter'] leading-[24px] font-[400] text-[16px] text-[#FFF] pb-[24px]">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque diam pellentesque bibendum non dui volutpat fringilla bibendum. Urna, elit augue urna, vitae feugiat pretium donec id elementum. Ultrices mattis sed vitae mus risus. Lacus nisi, et ac dapibus sit eu velit in consequat.
                </div>
                <div className="flex flex-col gap-[24px] font-['Inter'] text-[18px] leading-[26px] text-[#FFF]">
