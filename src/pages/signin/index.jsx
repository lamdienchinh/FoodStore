        ...
        <div className="bg-primary-background relative w-[auto]">
            <div className="pb-[10px]">
                ...
                <div className="py-[50px] bg-[#FFF] flex justify-center items-center">
                    <div className="w-[30%] relative custom-box flex flex-col px-[20px] pb-[32px]">
                        <h1 className="text-start pt-[32px] pb-[12px] text-[#333] font-['Helvetica'] text-[20px] font-[700] leading-[28px]">
                            Sign In
                        </h1>
                        <form className="mx-[20px] flex w-[100%] h-[44px] border border-solid border-[#E0E0E0] self-center pl-[16px] pt-[10px] pb-[10px]">
                        ...
                        <form className="mx-[20px] mt-[16px] w-[100%] flex h-[44px] border border-solid border-[#E0E0E0] self-center pl-[16px] pt-[10px] pb-[10px]">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <button className="bg-[#FFF] rounded-none border border-[#E0E0E0] relative w-[100%] flex flex-row px-[16px] py-[10px] mb-[32px] cursor-pointer font-['Helvetica'] text-[16px] leading-[24px] text-center justify-center items-center self-center">
                            <img className="absolute left-[16px] justify-self-start self-start" src={gg} alt="google logo"></img>
                            <div className="justify-self-center self-center">
                                Sign Up with Google
                            </div>
                        </button>
                        <button className="bg-[#FFF] rounded-none border border-[#E0E0E0] relative w-[100%] flex flex-row px-[16px] py-[10px] mb-[12px] cursor-pointer font-['Helvetica'] text-[16px] leading-[24px] text-center justify-center items-center self-center">
