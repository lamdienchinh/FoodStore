...
function Header() {
    return (
        <div className="navbar w-[1920px] h-[87px] mx-auto absolute top-[45px] pr-[300px] pl-[300px] bg-transparent" >
            <div className="header__logo font-['Helvetica']">
            ...
            <div className="flex items-center relative">
                ...
                <div className="flex flex-row justify-items-center justify-center content-center absolute right-[32px] shrink-0 w-[310px] h-[54px] rounded-[27px] border-solid border border-primary-orange">
                    ...
                    {/* <p className="text-justify mt-[14px] mb-[16px] ml-[26px] text-[#FFF] text-[16px] font-[400] font-['Inter'] leading-[24px]">Search...</p> */}
