        ...
        <div className="w-[auto] pb-[30px] mx-auto bg-transparent" >
            ...
            <div className="flex items-center relative z-[2]" >
                <div className="header__items">
                    ...
                    <NavLink to="/menu" className="header__item">Menu</NavLink>
                    <NavLink to="/blogs" className="header__item">Blogs</NavLink>
                    <NavLink to="/pages" className="header__item">Pages</NavLink>
                    <NavLink to="/about" className="header__item">About</NavLink>
                    <NavLink to="/shoplist" className="header__item">Shop</NavLink>
                    <NavLink to="/contact" className="header__item">Contact</NavLink>
                ...
                <div className="flex flex-row justify-items-center justify-center content-center absolute right-[32px] shrink-0 w-[310px] h-[54px] rounded-[27px] border-solid border border-primary-orange">
                    ...
                    <div className="cursor-pointer flex justify-end items-center content-center w-[100%] h-[100%] pr-[16px]">
                ...
                <div className="absolute right-[0px] cursor-pointer">
                    <Link to="/cart">
